...
| 10 | Reference Data Collections: Sets, Maps, Map of Sets, Map of Maps, and Tables | `chapters\part10-reference-data-collections.md` | The full typed reference-data taxonomy beyond the single Reference Set DEH Part 27 §2.2 introduces; when each type (Set, Map, Map of Sets, Map of Maps, Table) is the right structural fit; TTL/expiry management; populating via Rule Response, the REST API, or a bulk Reference Data import, and the drift risk of each population path getting out of sync with the others. | Blind Spot, Noisy Offense Trap |
...
|---|---|---|---|
| A1 | QRadar Terminology Addendum | `appendices\a1-qradar-terminology-addendum.md` | Platform-specific glossary (Offense, Magnitude/Credibility/Relevance/Severity, QID, DSM, Ariel, CRE, Building Block, Reference Set/Map/Map of Sets/Map of Maps/Table, Domain, Tenant, EPS/FPM) — extends, never redefines, DEH `TERMINOLOGY.md`. |
