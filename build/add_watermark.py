...
if __name__ == "__main__":
    in_path = sys.argv[1] if len(sys.argv) > 1 else r"C:\Users\User\projects\qradar-soc-operations-handbook\_build\QRadar_SOC_Operations.pdf"
    out_path = sys.argv[2] if len(sys.argv) > 2 else r"C:\Users\User\projects\qradar-soc-operations-handbook\_build\QRadar_SOC_Operations_watermarked.pdf"
