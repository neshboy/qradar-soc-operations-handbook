...
- **A denylist fed by an external feed** — a Reference Set of known-malicious source IPs, populated by a threat-intel integration, checked by a Rule Test on every inbound connection event.
